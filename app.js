document.addEventListener('DOMContentLoaded', () => {
  ...
  const theTetrominoes = [lTetromino, zTetromino, tTetrimino, oTetromino, iTetrimino]
  ...
  //  move the tetrominoright, unless its at the edge or there is a blockage
  function moveRight () {
    undraw()
  ...
  // show up-next tetromino without rotation
